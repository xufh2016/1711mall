...
<body class="signin">
					...
					<table >
						<tr style="align-content: center;align-items: center;" >
							...
							<td><img id="checkCodeImg"
								src="${pageContext.request.contextPath}/check/image.action"
	...
	<script type="text/javascript">
		...
		function refreshCode() {
			$("#checkCodeImg").attr(
					"src",
					"${pageContext.request.contextPath}/check/image.action?"
							+ Math.random());
		}
		function submitForm() {
			...
			$.ajax({
				url : "${ctx}/manager/user/login.action",//发送请求的地址
				type : "POST",
				dataType : "json",
